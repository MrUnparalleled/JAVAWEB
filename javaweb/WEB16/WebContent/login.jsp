		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<div>&nbsp;</div>
					<form class="form-horizontal" method="post" action="/WEB16/login">
						<div class="form-group">
							<label for="username" class="col-sm-2 control-label">用户名</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="username" name="username"
									placeholder="请输入用户名"><span><%=request.getAttribute("CheckImgInfo")==null?"":request.getAttribute("CheckImgInfo") %></span>
							</div>
						</div>
						<div class="form-group">
