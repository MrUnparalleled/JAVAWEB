...
<script type="text/javascript">
	...
	function delProduct(pid){
		...
		$(function(){
			$("#is_hot option[value='${select.is_hot}']").prop("selected",true);
			$("#cid option[value='${select.cid}']").prop("selected",true);
		});
...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/selectProduct"
		method="post">
				...
				<tr>
					<td class="ta_01" align="right">
						...
						商品类别：<select id="cid" name="cid">
							...
							<c:forEach items="${categoryList }" var="category_one">
							<option value="${category_one.cid }">${category_one.cname }</option>
							</c:forEach>
						</select>
						商品名称：<input type="text" name="pname" value="${select.pname }">
						是否热门:<select id="is_hot" name="is_hot">
							<option value="">--请选择--</option>
							<option value="1">是</option>
							<option value="0">否</option>
						</select>
						<button type="submit" id="select" value="查找">查找</button>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<c:forEach items="${list }" var="product" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/adminEditUIProduct?pid=${product.pid}">
											<img
